    ...
    <>
      ...
      <div ref={cardViewEl} 
        ...
        <div>
          ...
          <button aria-label="slide 4" onClick={clickTheDot} data-value="4" className={ currentSlide === 4 ? `w-4 h-4 mx-1 bg-gray-300 border-2 border-red-300 rounded-full focus:outline-none hover:bg-red-400 hover:shadow-lg` : `w-4 h-4 mx-1 bg-gray-300 border-2 border-gray-300 rounded-full focus:outline-none hover:bg-red-400 hover:shadow-lg`}></button>
        </div>
        <div>
